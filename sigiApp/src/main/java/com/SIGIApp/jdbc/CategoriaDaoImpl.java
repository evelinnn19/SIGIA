...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT idCategoria, nombre, Estado FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( idCategoria, nombre, Estado ) VALUES ( ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET idCategoria = ?, nombre = ?, Estado = ? WHERE idCategoria = ?";
	...
	public void update(CategoriaPk pk, Categoria dto) throws CategoriaDaoException
	{
		...
		try {
			...
			stmt.setString( index++, dto.getNombre() );
			stmt.setShort( index++, dto.getEstado() );
			stmt.setInt( 4, pk.getIdCategoria() );
			int rows = stmt.executeUpdate();
			reset(dto);
			long t2 = System.currentTimeMillis();
			System.out.println( rows + " rows affected (" + (t2-t1) + " ms)" );
	...
	/** 
	 * Returns all rows from the Categoria table that match the criteria 'Estado = :estado'.
	 */
	public Categoria[] findWhereEstadoEquals(short estado) throws CategoriaDaoException
	{
